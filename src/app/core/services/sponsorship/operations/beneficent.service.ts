...
import { filterBeneficentDto,PagedResult,beneficentDto,filterBeneficentByIdDto } from '../../../dtos/sponsorship/operations/beneficent.dto';
import { ApiEndpoints } from '../../../constants/api-endpoints';
import { SelectdropdownResult } from '../../../dtos/FndLookUpValuesdtos/FndLookUpValues.dto';
@Injectable({
  providedIn: 'root'
})
