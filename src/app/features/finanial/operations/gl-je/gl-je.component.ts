...
import {
  GljeDetailsDto,
  filterGljeListHeaderDto,
  getgljeByIDDto,
  gljeHeaderDto,
} from '../../../../core/dtos/FinancialDtos/OperationDtos/gl-je.models';
...
export class GLJEComponent implements OnInit {
  ...
  searchFndLookUpValuesSelect2RequestDto =
    new FndLookUpValuesSelect2RequestDto();
  ...
  constructor(
    private gljeService: gljeService,
  ...
  fetchentitySelect2(): void {
    ...
    this.searchSelect2RequestDto.searchValue =
      this.entitysearchParams.searchValue;
  ...
  fetchstatusSelect2(): void {
    ...
    this.searchSelect2RequestDto.searchValue =
      this.statussearchParams.searchValue;
  ...
  fetchje_CurrSelect2(): void {
    ...
    this.searchSelect2RequestDto.searchValue =
      this.je_CurrsearchParams.searchValue;
  ...
  fetchje_SoureSelect2(): void {
    ...
    this.searchSelect2RequestDto.searchValue =
      this.je_SouresearchParams.searchValue;
  ...
  getFormDatabyId(
    ...
    forkJoin({
      loadformData: this.gljeService.getDetailById(params) as Observable<
        gljeHeaderDto | gljeHeaderDto[]
      >,
      gljedetaildata: this.gljeService.getLineDatabyId(params) as Observable<
        GljeDetailsDto[]
      >,
    })
      .pipe(takeUntil(this.destroy$))
      .subscribe({
        next: (result) => {
          ...
          this.paginationlineData.totalCount =
            result?.gljedetaildata.length || 0;
  ...
  public buildColumnDefs(): void {
    this.columnDefs = [
      {
        headerName: this.translate.instant('glJEResourceName.jvNo'),
        field: 'attributE10',
        width: 200,
      },
      {
        headerName: this.translate.instant('glJEResourceName.jvName'),
        field: 'jE_NAME',
        width: 200,
      },
      {
        headerName: this.translate.instant('glJEResourceName.jvDate'),
        field: 'jE_DATEstr',
        width: 200,
      },
      {
        headerName: this.translate.instant('glJEResourceName.period'),
        field: 'perioD_ID',
        width: 200,
      },
      {
        headerName: this.translate.instant('glJEResourceName.referenceNo'),
        field: 'jE_SOURCE_DESC',
        width: 200,
      },
      {
        headerName: this.translate.instant('glJEResourceName.jvStatus'),
        field: 'jE_STATUS',
        width: 200,
      },
      {
        headerName: this.translate.instant('glJEResourceName.currency'),
        field: 'jE_CURR_DESC',
        width: 200,
      },
    ];
    ...
    this.columnDefslineData = [
      {
        headerName: this.translate.instant('glJEResourceName.accountNo'),
        field: 'accountnumber',
        width: 200,
      },
      {
        headerName: this.translate.instant('glJEResourceName.accountName'),
        field: 'accountNameAr',
        width: 200,
      },
      {
        headerName: this.translate.instant('glJEResourceName.jvDesc'),
        field: 'sourcE_DESC_DETAILS',
        width: 200,
      },
      {
        headerName: this.translate.instant('glJEResourceName.credit'),
        field: 'debiT_AMOUNT',
        width: 200,
      },
      {
        headerName: this.translate.instant('glJEResourceName.debit'),
        field: 'crediT_AMOUNT',
        width: 200,
      },
    ];
              ...
              next: (response: any) => {
                ...
                const reportConfig: reportPrintConfig = {
                  ...
                  fileName: `${this.translate.instant(
                    'glJEResourceName.title'
                  )}_${new Date().toISOString().slice(0, 10)}.xlsx`,
                  fields: [
                    {
                      label: this.translate.instant(
                        'glJEResourceName.entityId'
                      ),
                      value: this.searchParams.entityIdstr,
                    },
                    {
                      label: this.translate.instant('glJEResourceName.jvNo'),
                      value: this.searchParams.att10,
                    },
                    {
                      label: this.translate.instant('glJEResourceName.jvName'),
                      value: this.searchParams.jE_NAME,
                    },
                    {
                      label: this.translate.instant(
                        'glJEResourceName.jvManualNo'
                      ),
                      value: this.searchParams.att7,
                    },
                    {
                      label: this.translate.instant('glJEResourceName.value'),
                      value: this.searchParams.att7,
                    },
                    {
                      label: this.translate.instant(
                        'glJEResourceName.referenceNo'
                      ),
                      value: this.searchParams.je_Soure,
                    },
                    {
                      label: this.translate.instant(
                        'glJEResourceName.jvStatus'
                      ),
                      value: this.searchParams.je_State,
                    },
                    {
                      label: this.translate.instant('glJEResourceName.jvDate'),
                      value: this.searchParams.je_Date,
                    },
                    {
                      label: this.translate.instant(
                        'glJEResourceName.currency'
                      ),
                      value: this.searchParams.je_Curr,
                    },
                    {
                      label: this.translate.instant(
                  ...
                  columns: [
                    ...
                    {
                      label: this.translate.instant('glJEResourceName.period'),
                      key: 'perioD_ID',
                    },
                    {
                      label: this.translate.instant(
