...
export class receiptRPTComponent {
  ...
  getLoadDataGrid(event: { pageNumber: number; pageSize: number }): void {
    ...
    this.financialReportService
      .getreceiptRPTData(this.searchParams)
      .pipe(takeUntil(this.destroy$))
      .subscribe({
        next: (response: any) => {
    ...
    this.columnDefs = [
      {
        headerName: this.translate.instant(
          'FinancialReportResourceName.paymentCategory'
        ),
      ...
      {
        headerName: this.translate.instant(
          'FinancialReportResourceName.paymentNumber'
        ),
      ...
      {
        headerName: this.translate.instant(
          'FinancialReportResourceName.paymentDate'
        ),
      ...
      {
        headerName: this.translate.instant(
          'FinancialReportResourceName.paymentType'
        ),
        field: 'paymenT_TYPE',
        width: 200,
      },
      ...
      {
        headerName: this.translate.instant(
          'FinancialReportResourceName.bankAccount'
        ),
        field: 'banK_ACCOUNT',
        width: 200,
      },
  ...
  printExcel(): void {
    ...
    this.financialReportService
      .getreceiptRPTData({ ...cleanedFilters })
      .pipe(takeUntil(this.destroy$))
      .subscribe({
        next: (initialResponse: any) => {
          ...
          this.financialReportService
            .getreceiptRPTData({ ...cleanedFilters, skip: 0, take: totalCount })
            .pipe(takeUntil(this.destroy$))
            .subscribe({
              next: (response: any) => {
                ...
                const reportConfig: reportPrintConfig = {
                  title: this.translate.instant(
                    'FinancialReportResourceName.receiptRpt_Title'
                  ),
