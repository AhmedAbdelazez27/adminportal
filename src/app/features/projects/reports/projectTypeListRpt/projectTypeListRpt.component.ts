...
@Component({
  selector: 'app-projectTypeListRpt',
  standalone: true,
  imports: [CommonModule, FormsModule, TranslateModule, NgSelectComponent, GenericDataTableComponent],
  templateUrl: './projectTypeListRpt.component.html',
  styleUrls: ['./projectTypeListRpt.component.scss']
})

export class projectTypeListRptComponent {
  ...
  private buildColumnDefs(): void {
    this.translate.get([
      ...
      'ProjectReportResourceName.projecT_TYPE_DESC',
            ...
            .subscribe({
              next: (response: any) => {
                ...
                const reportConfig: reportPrintConfig = {
                  title: this.translate.instant('ProjectReportResourceName.projectTypeListRpt_Title'),
                  reportTitle: this.translate.instant('ProjectReportResourceName.projectTypeListRpt_Title'),
                  fileName: `${this.translate.instant('ProjectReportResourceName.projectTypeListRpt_Title')}_${new Date().toISOString().slice(0, 10)}.xlsx`,
                  fields: [
