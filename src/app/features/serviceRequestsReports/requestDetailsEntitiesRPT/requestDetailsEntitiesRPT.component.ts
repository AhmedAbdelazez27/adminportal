...
import { requestDetailsEntitiesRPTInputDto } from '../../../core/dtos/serviceRequests/serviceRequestsReportsInput.dto';
import { requestDetailsEntitiesRPTOutputDto } from '../../../core/dtos/serviceRequests/serviceRequestsReportsOutput.dto';
...
@Component({
  selector: 'app-requestDetailsEntitiesRPT',
  standalone: true,
  imports: [CommonModule, FormsModule, TranslateModule, NgSelectComponent, GenericDataTableComponent],
  templateUrl: './requestDetailsEntitiesRPT.component.html',
  styleUrls: ['./requestDetailsEntitiesRPT.component.scss']
})

export class requestDetailsEntitiesRPTComponent {
  ...
  searchParams = new requestDetailsEntitiesRPTInputDto();
  getAllDataForReports: requestDetailsEntitiesRPTOutputDto[] = [];
  ...
  getLoadDataGrid(event: { pageNumber: number; pageSize: number }): void {
    ...
    this.serviceRequestsReportsService.getserviceRequestsDetailsRptData(this.searchParams)
      .pipe(takeUntil(this.destroy$)).subscribe({
        next: (response: any) => {
  ...
  clear(): void {
    this.searchParams = new requestDetailsEntitiesRPTInputDto();
  ...
  public buildColumnDefs(): void {
    this.translate.get([
      'ServiceRequestsReportsResourceName.requestNo',
      'ServiceRequestsReportsResourceName.requestDate',
      'ServiceRequestsReportsResourceName.requestType',
      'ServiceRequestsReportsResourceName.entity',
      'ServiceRequestsReportsResourceName.requestName',
      'ServiceRequestsReportsResourceName.requestStatus',
      'ServiceRequestsReportsResourceName.targetedAmount',
      'ServiceRequestsReportsResourceName.startDate',
      'ServiceRequestsReportsResourceName.endDate',
      'ServiceRequestsReportsResourceName.permissionNo',
    ]).subscribe(translations => {
      this.columnDefs = [
        {
          headerName: '#',
        ...
        { headerName: translations['ServiceRequestsReportsResourceName.requestNo'], field: 'requestNo', width: 200 },
        { headerName: translations['ServiceRequestsReportsResourceName.requestDate'], field: 'requestDatestr', width: 200 },
  ...
  printExcel(): void {
    ...
    this.serviceRequestsReportsService.getserviceRequestsDetailsRptData(cleanedFilters)
      .pipe(takeUntil(this.destroy$))
      .subscribe({
        next: (initialResponse: any) => {
          const totalCount = initialResponse?.totalCount || initialResponse?.data?.length || 0;

          this.serviceRequestsReportsService.getserviceRequestsDetailsRptData({ ...cleanedFilters, skip: 0, take: totalCount })
            .pipe(takeUntil(this.destroy$))
            .subscribe({
              next: (response: any) => {
                ...
                const reportConfig: reportPrintConfig = {
                  title: this.translate.instant('ServiceRequestsReportsResourceName.requestDetailsEntitiesRPT_Title'),
                  reportTitle: this.translate.instant('ServiceRequestsReportsResourceName.requestDetailsEntitiesRPT_Title'),
                  fileName: `${this.translate.instant('ServiceRequestsReportsResourceName.requestDetailsEntitiesRPT_Title')}_${new Date().toISOString().slice(0, 10)}.xlsx`,
                  fields: [
                  ...
                  columns: [
                    ...
                    { label: this.translate.instant('ServiceRequestsReportsResourceName.requestNo'), key: 'entity' },
                    { label: this.translate.instant('ServiceRequestsReportsResourceName.requestDate'), key: 'requestTypestr' },
                    ...
                    { label: this.translate.instant('ServiceRequestsReportsResourceName.requestName'), key: 'requestName' },
                    { label: this.translate.instant('ServiceRequestsReportsResourceName.requestStatus'), key: 'requestStatus' },
                    { label: this.translate.instant('ServiceRequestsReportsResourceName.targetedAmount'), key: 'targetedAmountstr' },
                    { label: this.translate.instant('ServiceRequestsReportsResourceName.startDate'), key: 'startDatestr' },
                    { label: this.translate.instant('ServiceRequestsReportsResourceName.endDate'), key: 'endDatestr' },
                    { label: this.translate.instant('ServiceRequestsReportsResourceName.permissionNo'), key: 'permissionNo' },
                  ],
