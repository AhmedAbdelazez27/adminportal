...
import { TentLocationTypeDto, FastingTentPartnerDto, FastingTentAttachmentDto, CreateFastingTentRequestDto, LocationDetailsDto, LocationMapDto, Select2Item, PartnerType } from '../../../core/dtos/service/FastingTentRequest/fasting-tent-request.dto';
import { FastingTentRequestService } from '../../../core/services/mainApplyService/fasting-tent-request.service';
...
export class FastingTentRequestComponent implements OnInit, OnDestroy {
  ...
  initializeForms(): void {
    ...
    this.mainInfoForm = this.fb.group({
      ...
      servicesType: [ServicesType.TentPermission],
    });
  ...
  onSubmit(): void {
    ...
    try {
      ...
      const createDto: CreateFastingTentRequestDto = {
        ...
        servicesType: ServicesType.TentPermission, // Always send as enum value
