...
import { DistributionLocationTypeDto, Select2Item, DistributionSitePartnerDto, DistributionSiteAttachmentDto, PartnerType, CreateDistributionSiteRequestDto } from '../../../core/dtos/service/DistributionSiteRequest/distribution-site-request.dto';
import { ServiceType } from '../../../core/dtos/serviceSetting/serviceSetting.dto';
import { DistributionSiteRequestService } from '../../../core/services/mainApplyService/distribution-site-request.service';
import { ServicesType } from '../../../core/enum/user-type.enum';
...
export class DistributionSitePermitComponent implements OnInit, OnDestroy {
  ...
  initializeForms(): void {
    ...
    this.mainInfoForm = this.fb.group({
      ...
      serviceType: [ServicesType.DistributionSitePermitApplication],
  ...
  loadAttachmentConfigs(): void {
    this.attachmentService.getAttachmentsConfigByServiceType(
