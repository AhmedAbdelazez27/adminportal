...
@Component({
  selector: 'app-fastingServiceInquery',
  standalone: true,
  imports: [CommonModule, FormsModule, TranslateModule, GenericDataTableComponent, NgSelectModule, ReactiveFormsModule
  ],
  templateUrl: './fastingServiceInquery.component.html',
  styleUrls: ['./fastingServiceInquery.component.scss']
})



export class FastingServiceInqueryComponent {
